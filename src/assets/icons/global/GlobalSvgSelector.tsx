...
//создаем svg картинки
const BlobalSvgSelector = ({ id }: Props) => {
  switch (id) {
    case 'header-logo':
      return (
        <svg
...
export default BlobalSvgSelector;
